...
import com.rush.cycletome.BikeModel;
import com.rush.cycletome.VM;
import com.rush.cycletome.VerificationResult;
import com.rush.cycletome.VerificationResult.BikeStatus;
		...
		queryStolen.findInBackground(new FindCallback<ParseObject>() {
			...
			public void done(List<ParseObject> arg0, ParseException arg1) {								
				if (arg0 == null || arg0.size() == 0) {
					Log.d("Search returned: " + arg0 + "exc: " + arg1);
